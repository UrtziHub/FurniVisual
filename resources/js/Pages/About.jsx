    ...
    <PageLayout user={auth.user}>
      ...
      <div className="flex flex-col items-center gap-8 sm:gap-20 mx-4 sm:mx-20 md:mx-8">
        <div className="flex flex-col md:flex-row mx-4 sm:mx-8 rounded-lg bg-gray-100 ">
          <div className="w-full md:w-1/2 p-4 sm:p-8 rounded-t-lg md:rounded-l-lg shadow-lg flex justify-center items-center">
          ...
          <img src="images/image1.jpg" alt="Company Logo" className="w-full md:w-1/2 rounded-b-lg md:rounded-r-lg shadow-lg" />
        </div>
        <div className="flex flex-col-reverse md:flex-row mx-4 sm:mx-8">
          <img src="images/image2.jpg" alt="Company Logo" className="w-full md:w-1/2 rounded-t-lg md:rounded-l-lg shadow-lg" />
          <div className="w-full md:w-1/2 bg-gray-100 p-4 sm:p-8 rounded-b-lg md:rounded-r-lg shadow-lg flex justify-center items-center ">
            <p className="text-sm sm:text-lg text-gray-700">
        ...
        <div className="flex flex-col justify-center items-center bg-gray-100 mx-4 sm:mx-8 md:mx-40 rounded-t-lg shadow-lg pb-4 sm:pb-10">
          <h1 className="pt-4 sm:pt-10 text-2xl sm:text-3xl">Our Team</h1>
          <p className="px-2 sm:px-4 md:px-52 py-4 sm:py-10 text-center text-sm sm:text-lx">Our Graphic Design Team, although not traditional artists, is a group of skilled professionals dedicated to enhancing your projects. We take pride in our after-sales support, ensuring your satisfaction with the final result.
