...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::create([
            ...
            'description' => 'Dining tables and chairs are the heart of any dining room, not only serving as the place where meals are eaten, but also as the center of family gatherings and conversations. Their choice is crucial for both functionality and aesthetics of the space.',
        ...
        Category::create([
            'name' => 'Kitchens',
            'description' => 'Kitchen cabinetry is a key element in organizing kitchen space, providing functionality, aesthetics, and convenience. Properly designed and constructed kitchen cabinets allow for efficient use of space, creating a kitchen that is not only stunning in design, but also conducive to daily cooking and family integration.',
            'image' => 'kitchens.jpg',
        ]);
